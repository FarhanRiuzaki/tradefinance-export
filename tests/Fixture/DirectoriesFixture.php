...
class DirectoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'slug' => ['type' => 'string', 'length' => 225, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'rght' => 1,
                'level' => 1,
                'created' => '2019-06-25 05:35:41',
                'created_by' => 1,
                'modified' => '2019-06-25 05:35:41',
                'modified_by' => 1
            ],
        ];
        parent::init();
