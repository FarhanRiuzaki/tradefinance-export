...
class UploadDocController extends AppController
{
    ...
    public function add($idMaker = null)
    {
        ...
        // code doc master
        $param = $this->PrmDocMast->find('all');
        // dd($param->All());
        $this->set(compact('uploadDoc','maker', 'code', 'param'));
    ...
    {
        $uploadDoc  = $this->{$this->primaryModel}->get($id, [
