...
<html lang="en" >
    ...
    <?php if (preg_match('/MSIE\s(?P<v>\d+)/i', @$_SERVER['HTTP_USER_AGENT'], $B) && $B['v'] <= 8): ?>
        <div align='center' class='center_ie'>
            <h1>Oops... </h1>
            <h3 align='center'>Silahkan buka kembali di Google Chrome, Firefox, Safari atau Edge.</h3>
        </div>
    <?php else:?>
    	<!-- begin:: Page -->
            <div class="kt-grid kt-grid--ver kt-grid--root">
                <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
                    <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
                        <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background-image: url('<?=$this->Url->build('/assets/dist/media/bg/bg1.jpg');?>'); background-size: 1600px 1200px;">
                            <div class="kt-login__section">
                                <!-- <div <div class="kt-login__block">
                                ...
                                <div class="kt-login__logo">
                                    ...
                                    <img class="" alt="Pic" src="<?=$image?>" width='350px'/>
                                </div>
                            </div>
                        </div>
