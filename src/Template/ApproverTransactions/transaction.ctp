                ...
                "columnDefs": [
                    { 
                        ...
                        render:function(id, e, t, n) {
                            ...
                            if(t.status == 1){
                                if(editUrl != ""){
                                    listLink += '<div class="col"><a class="btn btn-success btn-icon" href="'+editUrl+id+'" data-toggle="tooltip" data-placement="bottom" title="Verifikasi"><span class="flaticon2-checkmark"></span></a></div>\n ';
                                }
                            }
