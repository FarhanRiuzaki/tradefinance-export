 ...
 * @property \App\Model\Table\TransactionsDetailsTable|\Cake\ORM\Association\HasMany $TransactionsDetails
 *
...
class TransactionsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('TransactionsDetails', [
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('jenis_trx')
            ->maxLength('jenis_trx', 255)
            ->allowEmptyString('jenis_trx');

        $validator
            ->scalar('no_nota')
            ->maxLength('no_nota', 255)
            ->allowEmptyString('no_nota');

        $validator
            ->date('tgl_input_trx')
            ->allowEmptyDate('tgl_input_trx');

        $validator
            ->date('tgl_approve_trx')
            ->allowEmptyDate('tgl_approve_trx');
